...
```toml
[dependencies]
lode-core = { git = "https://github.com/dotns/lode", tag = "v0.3.1" }        # config + Engine (no clap, no signals)
lode-supervisor = { git = "https://github.com/dotns/lode", tag = "v0.3.1" }  # + the supervise loop, driven by an injected SignalSource
```
