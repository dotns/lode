...
```toml
[dependencies]
lode-core = { git = "https://github.com/dotns/lode", tag = "v0.3.1" }        # 配置 + Engine(无 clap、无信号)
lode-supervisor = { git = "https://github.com/dotns/lode", tag = "v0.3.1" }  # + 监管循环,由注入的 SignalSource 驱动
```
